...
const PropertyDetails = () => {
  ...
  return (
    <>
      <div className="container mx-auto p-6 pt-[136px]">
        {/* Back and Navigation */}
        <div className="flex items-center justify-between bg-white mb-4 p-8 pb-10 sticky top-16 z-10">
          <button
            onClick={() => router.push(`/home-listing`)}
        ...
        {isModalOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-100 flex justify-center items-center z-50">
            <div className="relative flex flex-col justify-center items-center max-w-screen-lg">
              ...
              <img
                src={
                  property.Media[activeImageIndex]?.MediaURL ||
                  "/placeholder.jpg"
                }
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="text-right">
                ...
                <p className="text-gray-500">
                  $
                  {(property.ListPrice / (property.LotSizeArea || 1)).toFixed(
                    2
                  )}{" "}
                  per sqft
                </p>
