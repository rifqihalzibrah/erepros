        ...
        <div className="pt-[136px] bg-white">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-justify">
                    <h1 className="text-4xl font-semibold text-gold font-marcellus uppercase mb-4">
                        HOA Management
                    </h1>
                    ...
                    <p className="text-gray-700 mb-6">
                        ...
                        gain access to shared amenities such as pools, clubhouses, and fitness
                        centers, alongside convenient services like common area maintenance,
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
                <h2 className="text-2xl text-gold mb-6 text-left font-marcellus uppercase">
                    Elite Real Estate Professionals Can Provide a Range of Essential Services:
                </h2>
