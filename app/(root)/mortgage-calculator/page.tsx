...
const MortgageCalculator = () => {
  ...
  const loanTerm = 30; // Fixed 30-Year Loan Term
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8">
      {/* Base Header */}
      <h1 className="text-4xl font-serif text-center text-gold-500 mb-8">
        Mortgage Calculator
      </h1>
      ...
      <div className="flex justify-between mt-8">
        ...
        <button className="px-6 py-2 bg-blue-700 text-white rounded shadow">
          Get a custom quote
        </button>
      </div>
