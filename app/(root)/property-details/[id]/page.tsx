...
const PropertyDetails = () => {
  ...
  return (
    <>
      <div className="container mx-auto p-6 pt-[136px]">
        ...
        <div className="flex items-center justify-between  bg-white mb-4 sticky top-16 ">
          <div>
            <a
              onClick={() =>
                router.push(`/available-rentals?page=${page || 1}`)
              }
      ...
      {/* Footer Section with "Apply Now" Button */}
          ...
          onClick={() =>
            router.push(
              `/apply-tenants?property_id=${
                property.id
              }&address=${encodeURIComponent(property.address)}&bedrooms=${
                property.no_bedrooms || "N/A"
              }`
            )
          }
