          ...
          if (Array.isArray(file)) {
            const uploadTasks = file.map((singleFile) => {
              if (singleFile instanceof File) {
                const fileRef = ref(
                  storage,
                  `applications/${Date.now()}_${singleFile.name}`
                );
            ...
            const fileRef = ref(
              storage,
              `applications/${Date.now()}_${file.name}`
            );
          ...
          >
                            ...
                            <FormControl>
                              <Checkbox
                                ...
                                disabled={
                                  ...
                                  pet !== "None" // Disable others when "None" is selected
                                }
              ...
              <div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Do you receive alimony, child support, or food/cash
                        assistance?
                      </FormLabel>
                      <FormControl>
                        <RadioGroup
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Do you have additional income (Section 8, SSI, DHS,
                        etc.)?
                      </FormLabel>
                      <FormControl>
                        <RadioGroup
              ...
              <div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Have you ever been served an eviction and/or asked to
                        vacate a property?
                      </FormLabel>
                      <FormControl>
                        <RadioGroup
            ...
            {currentStep === 8 && (
              <div>
                ...
                <p>
                  Disclaimer: Please upload files in JPEG, JPG, PNG, PDF, or PSD
                  format, with a maximum size of 5MB.
                </p>
                      ...
                      <FormItem>
                        ...
                        <FilePond
                          ...
                          onupdatefiles={(fileItems) => {
                            ...
                            const filesArray = fileItems.map(
                              (item) => item.file
                            );
            ...
            <div className="flex justify-between">
              ...
              {currentStep < totalSteps ? (
                <Button
                  className="bg-gold hover:bg-[#725836] text-white px-4 py-2 rounded"
                  asChild
                >
