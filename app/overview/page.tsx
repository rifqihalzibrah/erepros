...
const Overview = () => {
  return (
    <>
      {/* First Section */}
      <section className="flex flex-col lg:flex-row items-center justify-between px-6 py-12 lg:py-24 bg-white">
        {/* Text Section */}
        <div className="w-full lg:w-1/2 text-center lg:text-left lg:pr-8">
          <h1 className="text-3xl lg:text-5xl font-bold font-marcellus text-gray-800 mb-10 text-center">
            PROPERTY MANAGEMENT
          </h1>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Left Column Content */}
            <div>
              <h2 className="text-xl font-semibold tracking-wide text-gray-600 uppercase mb-4">
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between px-6 py-12 lg:py-24 bg-white">
        {/* Image Section */}
        <div className="w-full lg:w-1/2 mb-12 lg:mb-0 lg:mr-8">
          <img
